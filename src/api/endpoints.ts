...
export async function listChatbots(
  query?: operations['ChatbotController_getChatbots']['parameters']['query'],
) {
  type Get = operations['ChatbotController_getChatbots']
...
export async function sendMessage(
  chatbotId: string,
  payload: Body<paths['/chat/{chatbotUuid}/message']['post']>,
) {
  type Post = paths['/chat/{chatbotUuid}/message']['post']
...
export async function getChatbotSessions(
  chatbotUuid: string,
  query?: Record<string, unknown>, // <-- fallback for queries
) {
